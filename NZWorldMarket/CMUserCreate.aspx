<%@ Page Title="" Language="C#" MasterPageFile="~/ContentManager.Master" AutoEventWireup="true" CodeBehind="CMUserCreate.aspx.cs" Inherits="NZWorldMarket.CMUserCreate" %>
                ...
                <div class="row">
                    ...
                    <div class="px-4 py-3" >
                     ...
                     <%--   <div class="form-group">
                        ...
                        <asp:Button ID="btnCreate" runat="server" CssClass="btn btn-success" Text="Create" OnClick="btnCreate_Click" ValidationGroup="val"  />
