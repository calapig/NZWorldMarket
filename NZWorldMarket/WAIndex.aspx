...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server" >
     ...
     <asp:Repeater ID="rpCarousel" runat="server" DataSourceID="dsFvCarousel">
              <ItemTemplate>
                  <div class="carousel-item">
                      <%--<asp:Image ID="imgAdver" runat="server" ImageUrl='<%# Eval("PhotoId", "CommonResources/ShowImage.ashx?photoId={0}") %>'  style="max-width: 800px; height: 400px"  class="d-block w-100" AlternateText="First slide" />--%>
  ...
  <%--  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <asp:DataList ID="dlAdvertisements" runat="server" DataKeyField="Id" DataSourceID="dsDlAdvertisements" RepeatColumns="3" 
        OnItemDataBound="dlAdvertisements_ItemDataBound" OnItemCommand="dlAdvertisements_ItemCommand">
        <ItemTemplate>
            <div class="card border-primary text-white bg-dark mb-3">

                <div class="card-header bg-primary" style="padding: 0px" >
                ...
                <div class="card-body text-truncate" style="max-width: 250px">
